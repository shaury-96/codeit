...
(() => {
    ...
    var Z = Math.pow,
        ...
        A = (t, e) => {
            ...
            if (Y)
                for (var r of Y(e)) be.call(e, r) && J(t, r, e[r]);
            return t
        },
        G = (t, e) => ve(t, Te(e));
    var Le = (t, e) => () => (e || t((e = {
    ...
    var we = (t, e, r, n) => {
        if (e && typeof e == "object" || typeof e == "function")
            for (let i of Qe(e)) !X.call(t, i) && i !== r && U(t, i, {
                get: () => e[i],
                ...
                for (var n = e.toString().toLowerCase(), i = n.length, s = [], o = 0, a = 0; o <= i; o++) {
                    ...
                    if (u.match(t.tokenizer.separator) || o == i) {
                        if (c > 0) {
                            ...
                            l.position = [a, c], l.index = s.length, s.push(new t.Token(n.slice(a, o), l))
                        }
                        a = o + 1
                    }
                }
...
`, e)
            ...
            t.Vector = function(e) {
                ...
                for (var r = 0, n = this.elements, i = e.elements, s = n.length, o = i.length, a = 0, u = 0, c = 0, l = 0; c < s && l < o;) a = n[c], u = i[l], a < u ? c += 2 : a > u ? l += 2 : a == u && (r += n[c + 1] * i[l + 1], c += 2, l += 2);
                return r
            ...
            t.stemmer = function() {
                var e = {
                    ...
                    M = function(h) {
                        ...
                        if (L = h.substr(0, 1), L == "y" && (h = L.toUpperCase() + h.substr(1)), p = x, T = d, p.test(h) ? h = h.replace(p, "$1$2") : T.test(h) && (h = h.replace(T, "$1$2")), p = y, T = b, p.test(h)) {
                            var Q = p.exec(h);
                            p = g, p.test(Q[1]) && (p = E, h = h.replace(p, ""))
                        } else if (T.test(h)) {
                            var Q = T.exec(h);
                            S = Q[1], T = m, T.test(S) && (h = S, T = w, O = R, F = j, T.test(h) ? h = h + "e" : O.test(h) ? (p = E, h = h.replace(p, "")) : F.test(h) && (h = h + "e"))
                        }
                        if (p = _, p.test(h)) {
                            var Q = p.exec(h);
                            S = Q[1], h = S + "i"
                        ...
                        return p = z, T = f, p.test(h) && T.test(h) && (p = E, h = h.replace(p, "")), L == "y" && (h = L.toLowerCase() + h.substr(1)), h
                    };
                return function(I) {
                    return I.update(M)
                }
                    ...
                    if (s.editsRemaining != 0) {
                        ...
                        if (s.str.length > 1) {
                            var l = s.str.charAt(0),
                                g = s.str.charAt(1),
                                f;
                            g in s.node.edges ? f = s.node.edges[g] : (f = new t.TokenSet, s.node.edges[g] = f), s.str.length == 1 && (f.final = !0), i.push({
                                node: f,
                                editsRemaining: s.editsRemaining - 1,
                                str: l + s.str.slice(2)
                            })
                        ...
                        for (var l = s[c], g = 0; g < u; g++) {
                            ...
                            if (f == l || l == "*") {
                                var v = n.node.edges[f],
                                    ...
                                    x = v.final && m.final,
                                    d = void 0;
                                f in n.output.edges ? (d = n.output.edges[f], d.final = d.final || x) : (d = new t.TokenSet, d.final = x, n.output.edges[f] = d), i.push({
                                    qNode: m,
                                    output: d,
                                    node: v
                                })
            ...
            t.Index = function(e) {
                ...
                for (var u = 0; u < r.clauses.length; u++) {
                    var c = r.clauses[u],
                        l = null,
                        g = t.Set.empty;
                    c.usePipeline ? l = this.pipeline.runString(c.term, {
                        fields: c.fields
                    }) : l = [c.term];
                    for (var f = 0; f < l.length; f++) {
                        ...
                        if (x.length === 0 && c.presence === t.Query.presence.REQUIRED) {
                        ...
                        for (var b = 0; b < x.length; b++)
                            for (var E = x[b], w = this.invertedIndex[E], R = w._index, d = 0; d < c.fields.length; d++) {
                                var y = c.fields[d],
                                    j = w[y],
                                    _ = Object.keys(j),
                                    D = E + "/" + y,
            ...
            t.Builder = function() {
                    ...
                    for (var s = 0; s < i.length; s++) {
                        ...
                        this.fieldTermFrequencies[g] = f, this.fieldLengths[g] = 0, this.fieldLengths[g] += l.length;
                        for (var v = 0; v < l.length; v++) {
                            ...
                            for (var y = 0; y < this.metadataWhitelist.length; y++) {
                                var b = this.metadataWhitelist[y],
                                    E = m.metadata[b];
                                this.invertedIndex[m][o][n][b] == null && (this.invertedIndex[m][o][n][b] = []), this.invertedIndex[m][o][n][b].push(E)
                            }
                        }
                    }
                    ...
                    for (var e = {}, r = Object.keys(this.fieldTermFrequencies), n = r.length, i = Object.create(null), s = 0; s < n; s++) {
                        for (var o = t.FieldRef.fromString(r[s]), a = o.fieldName, u = this.fieldLengths[o], c = new t.Vector, l = this.fieldTermFrequencies[o], g = Object.keys(l), f = g.length, v = this._fields[a].boost || 1, m = this._documents[o.docRef].boost || 1, x = 0; x < f; x++) {
                            var d = g[x],
                                y = l[d],
                                b = this.invertedIndex[d]._index,
                                E, w, R;
                            i[d] === void 0 ? (E = t.idf(this.invertedIndex[d], this.documentCount), i[d] = E) : E = i[d], w = E * ((this._k1 + 1) * y) / (this._k1 * (1 - this._b + this._b * (u / this.averageFieldLength[a])) + y), w *= v, w *= m, R = Math.round(w * 1e3) / 1e3, c.insert(b, R)
                        }
                        e[o] = c
                    }
                    this.fieldVectors = e
                    ...
                    for (var r = Object.keys(e.metadata), n = 0; n < r.length; n++) {
                        ...
                        for (var o = 0; o < s.length; o++) {
                            ...
                            for (var c = 0; c < u.length; c++) {
                                var l = u[c];
                                this.metadata[i][a][l] == null ? this.metadata[i][a][l] = e.metadata[i][a][l] : this.metadata[i][a][l] = this.metadata[i][a][l].concat(e.metadata[i][a][l])
                            }
                        }
                    }
    ...
    function q(t, e, r) {
        ...
        for (let i = 1; i < e.length; i++) {
            let s = e[i - 1],
                ...
                u = o[0] >>> 12;
            n.push(+(a > u) + n[n.length - 1])
        }
        return t.map((i, s) => {
            let o = new Map;
            for (let u of r.sort((c, l) => c - l)) {
                let c = u & 1048575,
                    l = u >>> 20;
                if (n[l] !== s) continue;
                let g = o.get(l);
                typeof g == "undefined" && o.set(l, g = []), g.push(c)
            }
                        ...
                        W(g, lunr.tokenizer.separator, (f, v) => {
                            if (typeof lunr.segmenter != "undefined") {
                                ...
                                if (/^[MHIK]$/.test(lunr.segmenter.ctype_(m))) {
                                    ...
                                    for (let d = 0, y = 0; d < x.length; d++) i[o] || (i[o] = []), i[o].push(u + f + y << 12 | x[d].length << 2 | a), e.push(new lunr.Token(x[d].toLowerCase(), {
                                        position: o << 20 | i[o].length - 1
                                    })), y += x[d].length;
                                    return
                                }
                            }
                            i[o].push(u + f << 12 | v - f << 2 | a), e.push(new lunr.Token(g.slice(f, v).toLowerCase(), {
                                position: o << 20 | i[o].length - 1
                            }))
                        })
                }
    ...
    function ae(t, e = r => r) {
        return t.trim().split(/"([^"]+)"/g).map((r, n) => n & 1 ? r.replace(/^\b|^(?![^\x00-\x7F]|$)|\s+/g, " +") : r).join("").replace(/"|(?:^|\s+)[*+\-:^~]+(?=\s+|$)/g, "").split(/\s+/g).flatMap(e).map(r => /([~^]$)/.test(r) ? `${r}1` : r).map(r => /(^[+-]|[~^]\d+$)/.test(r) ? r : `${r}*`).join(" ")
    }
    ...
    function ue(t) {
        return ae(t, e => {
            ...
            for (let {
                ...
                } of n.lexemes) i === "TERM" && W(s, lunr.tokenizer.separator, (...u) => {
    ...
    var H = class {
        constructor({
            ...
            this.map = ne(r), this.options = n, this.index = lunr(function() {
                this.metadataWhitelist = ["position"], this.b(0), e.lang.length === 1 && e.lang[0] !== "en" ? this.use(lunr[e.lang[0]]) : e.lang.length > 1 && this.use(lunr.multiLanguage(...e.lang)), this.tokenizer = oe, lunr.tokenizer.separator = new RegExp(e.separator), lunr.segmenter = "TinySegmenter" in lunr ? new lunr.TinySegmenter : void 0;
        ...
        search(e) {
            if (e = e.replace(new RegExp("\\p{sc=Han}+", "gu"), s => [...he(s, this.index.invertedIndex)].join("* ")), e = ue(e), !e) return {
                items: []
            };
            let r = ce(e).filter(s => s.presence !== lunr.Query.presence.PROHIBITED),
                n = this.index.search(e).reduce((s, {
                    ref: o,
                    score: a,
                    matchData: u
                }) => {
                    ...
                    if (typeof c != "undefined") {
                        ...
                        let l = le(r, Object.keys(u.metadata));
                        for (let f of this.index.fields) {
                            if (typeof c[f] == "undefined") continue;
                            let v = [];
                            for (let d of Object.values(u.metadata)) typeof d[f] != "undefined" && v.push(...d[f].position);
                            if (!v.length) continue;
                            let m = this.table.get([c.location, f].join(":")),
                                x = Array.isArray(c[f]) ? q : se;
                            c[f] = x(c[f], m, v)
                        }
                        let g = +!c.parent + Object.values(l).filter(f => f).length / Object.keys(l).length;
                        s.push(G(A({}, c), {
                            score: a * (1 + Z(g, 2)),
                            terms: l
                        }))
    ...
    function Fe(t) {
        return B(this, null, function*() {
            switch (t.type) {
                case 0:
                    return yield Ie(t.data.config), fe = new H(t.data), {
                        type: 1
                    };
                case 2:
                    let e = t.data;
